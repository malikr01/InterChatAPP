...
object Routes {
    ...
    // Hesaplamalar alt rotaları (tek merkez)
    const val CALC_LOAN  = "calc/loan"
    const val CALC_PLANS = "calc/plans"
    const val CALC_INV   = "calc/invest"
    const val CALC_FX    = "calc/fx"
